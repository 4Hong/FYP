...
- 只需要加上对应改进的"AsDDet", "LADH", "SERDet", "ShareSepHead", "TransHead" Head检测头核心模块，该项目代码就可以直接运行各种`YOLOv8-xxx.yaml`检测头 网络配置文件，乐高式创新改进，一键运行即可
- 相关改进 支持答疑服务。代码详情见 ⭐⭐⭐ https://github.com/iscyy/ultralyticsPro/wiki/YOLOv8 ⭐⭐⭐ 说明
'''
...
try:
    ...
    elif ARGS_PA.newhead =='LADH':
        from .CoreV8.Head.LADH import LADH as Detect
        print('使用LADH检测头')
    elif ARGS_PA.newhead =='SERDet':
        from .CoreV8.Head.SERDet import SERDet as Detect
        print('使用SERDet检测头')
    elif ARGS_PA.newhead =='ShareSepHead':
        from .CoreV8.Head.ShareSepHead import ShareSepHead as Detect
        print('使用ShareSepHead检测头')
    elif ARGS_PA.newhead =='TransHead':
        from .CoreV8.Head.TransHead import TransHead as Detect
        print('使用TransHead检测头')
    elif ARGS_PA.newhead =='DynamicHead':
        from .CoreV8.Head.DynamicHead import DynamicHead as Detect
        print('使用DynamicHead检测头')
    elif ARGS_PA.newhead =='ImplicitHead':
        from .CoreV8.Head.ImplicitHead import ImplicitHead as Detect   
        print('使用ImplicitHead检测头') 
    else:
